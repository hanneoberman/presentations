...
<!-- ![](plot.pdf){fig-alt="Three scatterplots with the probability to be missing on the y-axis and the amputed variable on the x-axis" fig-align="center"} -->
...
-   methods used to construct standard errors and confidence intervals <!-- Such as rules by Barnard and Rubin (1999); Rubin (1987); Reiter (2003), etc. -->
...
-   validity of imputations (incl. imputation model fit and distributional characteristics) <!-- − Does the imputation model fit well to the observed values? (e.g., posterior predictive check) --> <!-- − Are there unrealistic values in the data? (e.g., negative where positive expected) --> <!-- − Are there implausible combinations in the data? (e.g., pregnant grandfathers) -->
