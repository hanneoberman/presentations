...
- Initial -2LL (null model) minus -2LL model 1: `r -2*LL0` $-$ `r -2*LL1` $=$ `r -2*LL0 - -2*LL1`.

- Model 1 -2LL minus -2LL model 2 (full model): `r -2*LL1` $-$ `r -2*LL2` $=$ `r -2*LL1 - -2*LL2`.
...
<!-- | Model | -2LL | df | Δ -2LL | Δ df | p | -->
<!-- |-||-|--||| -->
<!-- | Null Model | 170.529 | 1 | - | - | - | -->
<!-- | Model 1 | 123.506 | 5 | 47.022 | 4 | .000 | -->
<!-- | Model 2 | 116.693 | 6 | 6.813 | 1 | .009 | -->
...
- Female mock jurors have $e^{1.17} = 3.22$ **times** higher odds of deciding stop the study than male jurors.

- Increasing idealism by 1 unit **multiplies** the odds of deciding to stop rather than continue the study by $e^{-0.69} = 0.502$. Decreasing idealism by 1 unit **multiplies** the odds of deciding to stop rather than continue by $e^{0.69} = 2.01$.

- Increasing relativism by 1 unit **multiplies** the odds of deciding stop rather than continue by $e^{0.34} = 1.41$.
