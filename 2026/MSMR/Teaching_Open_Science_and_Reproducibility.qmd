...
renderthis::to_pdf(from = "2026/MSMR/Teaching_Open_Science_and_Reproducibility.qmd")
```
...
- discuss how Open Science was adopted as core principle for education at Utrecht University (UU);
- showcase how our department of Methodology & Statistics (M&S) teaches reproducibility in statistics and data science; and
- engage with the audience to exchange ideas about teaching reproducibility.
...
## Option 2: Reproducibility in M&S education
