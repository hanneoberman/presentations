...
renderthis::to_pdf(from = "2026/MSMR/Teaching_Open_Science_and_Reproducibility.qmd", to = "2026/MSMR/5-Oberman-Hanne.pdf", keep_intermediates = TRUE)
```

<!-- If we want methodologists to produce reproducible research, they should learn how to—sooner -->
<!-- rather than later.  -->
<!-- In this session, I want to: -->
<!-- - discuss how Open Science was adopted as core principle for education at Utrecht -->
<!-- University; -->
<!-- - showcase how our department of Methodology & Statistics teaches reproducibility in -->
<!-- statistics and data science; and  -->
<!-- - engage with the audience to exchange ideas about teaching reproducibility. -->
<!-- At Utrecht University, ‘Open Science’ was recently added to the educational model [1], making it -->
<!-- a core characteristic of our teaching. This means that students should encounter reproducibility -->
<!-- at every stage of their academic career. In practice, however, each course coordinator may have -->
<!-- to ‘reinvent the wheel’. That’s why the Community for Open Science in Education (COSiE) is -->
<!-- developing a quality model for reusing teaching materials about Open Science and -->
<!-- reproducibility [2].  -->
<!-- In our statistics and data science education for the social sciences, learning about reproducibility -->
<!-- is already part of the course aims all throughout the curriculum. Students first encounter the -->
<!-- practices in their very first course at our university, then again in the two subsequent Bachelor -->
<!-- level courses, and we even offer dedicated (post-)graduate courses about markup languages -->
<!-- and reproducible programming in statistics [3].  -->
<!-- Ideally, I would like to have more of an ‘unconference’ setting to discuss reproducibility as an -->
<!-- educational topic. For example, how can we best make use of ‘Open Educational Resources’? -->
<!-- There are so many great initiatives to make use of (such as FORRT [4], The Turing Way [5], The -->
<!-- Carpentries [6], etc.), but administrators often prefer to stick with textbooks and peer-reviewed -->
<!-- journal articles. How can we ensure that our teaching materials are both up to date, as well as -->
<!-- trustworthy? And how can materials be (re)used across disciplines? I’m hoping to share some of -->
<!-- our insights and learn from each other! -->
<!-- References -->
<!-- 1. The educational model - Education - Utrecht University. n.d. -->
<!-- https://www.uu.nl/en/education/educational-vision/the-educational-model (8 Apr. 2026, date -->
<!-- last accessed). -->
<!-- 2. COSiE: Community for Open Science in Education. Open Science Community Utrecht n.d. -->
<!-- https://openscience-utrecht.com/cosie/ (8 Apr. 2026, date last accessed). -->
<!-- 3. Mosteiro P, Oberman HI. Markup Languages and Reproducible Programming in Statistics. -->
<!-- 26 Feb. 2026. https://mlarpis.github.io/markup/ (8 Apr. 2026, date last accessed). -->
<!-- 4. FORRT - Framework for Open and Reproducible Research Training. FORRT - Framework for -->
<!-- Open and Reproducible Research Training. n.d. https://forrt.org/ (8 Apr. 2026, date last -->
<!-- accessed). -->
<!-- 5. Community TTW. The Turing Way: A Handbook for Reproducible, Ethical and Collaborative -->
<!-- Research. Zenodo, 14 Apr. 2025. https://doi.org/10.5281/zenodo.15213042. -->
<!-- 6. The Carpentries. The Carpentires. n.d. https://carpentries.org/ (8 Apr. 2026, date last -->
<!-- accessed). -->

<!-- For this session, I wanted to: -->
...
<!-- I might have over-promised... so let's vote!  -->

## Option 1: Open Science at UU  {visibility="hidden"}
...
## Option 2: Reproducibility in M&S education  {visibility="hidden"}
...
## Option 3: Exchange of ideas  {visibility="hidden"}

Ideally, I would like to have more of an ‘unconference’ setting to discuss reproducibility as an educational topic. For example, how can we best make use of ‘Open Educational Resources’? There are so many great initiatives to make use of (such as FORRT, The Turing Way, The Carpentries, etc.), but administrators often prefer to stick with textbooks and peer-reviewed journal articles. How can we ensure that our teaching materials are both up to date, as well as trustworthy? And how can materials be (re)used across disciplines?

## ☝️ {visibility="hidden"}

# Open Science at UU {background-color="#FFCD00"}
...
::: footer
[uu.nl/en/research/open-science](https://www.uu.nl/en/research/open-science)
:::
...
::: footer
[openscience-utrecht.com/cosie](https://openscience-utrecht.com/cosie/)
:::

## OER on OS


![](img/qualitymod.jpg){height=450}
![](img/owf.png){height=450}
![](img/qualitymod2.png){height=450}

::: footer
[openscience-utrecht.com/cosie](https://openscience-utrecht.com/cosie/)
:::

# Teaching reproducibility <br>in M&S courses {background-color="#FFCD00"}

## OS as mandatory element

![](img/UU_logo.svg){fig-width="3"}
...
::: footer
[mlarpis.github.io/markup](https://mlarpis.github.io/markup/)
:::

## Markup Languages and Reproducible Programming in Statistics

<!-- In our course, students are taught various tools and languages, such as Quarto markdown, version control with git, reproducible environments for `R` with `renv`, code sharing for reuse. -->
...
## Course weeks {visibility="hidden"}
...
## Reusable course elements  {visibility="hidden"}
...
## Missing element(s)?  {visibility="hidden"}
...
# Discussion {background-color="#FFCD00"}
...
::: footer
[forrt.org](https://forrt.org/)
:::

## How to convince administrators?

![](img/turing_roadmap.jpeg)
...
# Mini lecture: Reproducibility {background-color="#FFCD00"}
...
# Mini lecture: Research Compendiums {background-color="#FFCD00"}
